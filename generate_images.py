...
def parse_args():
    ...
    parser.add_argument('--subject', type=int, default=80000, help='how many subjects to generate.')
    parser.add_argument('--variation', type=int, default=1, help='how many images to generate per subject.')
    parser.add_argument('--model',type=str,default='network-snapshot-020126.pkl',help='pkl file name of the generator. If None, use the default pre-trained model.')
